...
class _TOPRFFinalizeWorker {
  final SendPort _commands;
  final ReceivePort _responses;

  static const _debugLabel = '_TOPRFFinalizeWorker';

  _TOPRFFinalizeWorker._(this._commands, this._responses) {
  ...
  Future<String> toprfFinalize(Uint8List inputBytes) async {
  ...
  static Future<_TOPRFFinalizeWorker> spawn() async {
